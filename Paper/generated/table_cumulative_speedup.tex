...
SuperSNEC codebase & 8.7 & $78\times$ & $1.0\times$ & 0.074 \\
Solver tolerance ($10^{-7} \to 10^{-4}$) & 7.7 & $87\times$ & $1.1\times$ & 0.075 \\
Ni ray-tracing optimization & 3.3 & $202\times$ & $2.3\times$ & 0.076 \\
Ni cadence ($f_{\mathrm{Ni}}{=}0.10$) & 3.0 & $222\times$ & $1.1\times$ & 0.075 \\
Quadrature ($150 \to 70$) & 1.8 & $373\times$ & $1.7\times$ & 0.077 \\
Adaptive grid + $f_{\mathrm{Ni}}{=}0.20$ & 1.6 & $410\times$ & $1.1\times$ & 0.022 \\
\hline
\textbf{Total (SuperSNEC baseline)} & \textbf{1.6} & $\mathbf{410\times}$ & --- & \textbf{0.022} \\
\hline
Fast ($N{=}60$, $n_{quad}{=}50$) & 0.8 & $843\times$ & $2.1\times$ & 0.052 \\
\hline
\\
\multicolumn{5}{c}{\textit{Production grid mode (\texttt{output\_mode=1}; Sect.~\ref{sec:output_mode})}} \\
\hline
Baseline & 1.4 & $493\times$ & $1.2\times$ & 0.022 \\
Fast & 0.6 & $1089\times$ & $1.3\times$ & 0.052 \\
\enddata
