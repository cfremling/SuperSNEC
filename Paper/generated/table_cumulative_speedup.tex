...
SuperSNEC codebase & 8.5 & $79\times$ & $1.0\times$ & 0.074 \\
Solver tolerance ($10^{-7} \to 10^{-4}$) & 7.2 & $93\times$ & $1.2\times$ & 0.075 \\
Ni ray-tracing optimization & 3.4 & $200\times$ & $2.1\times$ & 0.076 \\
Ni cadence ($f_{\mathrm{Ni}}{=}0.10$) & 3.1 & $218\times$ & $1.1\times$ & 0.075 \\
Quadrature ($150 \to 70$) & 1.7 & $389\times$ & $1.8\times$ & 0.077 \\
Adaptive grid + $f_{\mathrm{Ni}}{=}0.20$ & 1.6 & $419\times$ & $1.1\times$ & 0.022 \\
\hline
\textbf{Total (SuperSNEC baseline)} & \textbf{1.6} & $\mathbf{419\times}$ & --- & \textbf{0.022} \\
\hline
Fast ($N{=}60$, $n_{quad}{=}50$) & 0.8 & $850\times$ & $2.0\times$ & 0.052 \\
\hline
\\
\multicolumn{5}{c}{\textit{Production grid mode (\texttt{output\_mode=1}; Sect.~\ref{sec:output_mode})}} \\
\hline
Baseline & 1.4 & $480\times$ & $1.1\times$ & 0.022 \\
Fast & 0.6 & $1033\times$ & $1.2\times$ & 0.052 \\
\enddata
