...
The Saha caching optimization could plausibly yield a further ${\sim}10$--$20\%$ speedup; whether this is worth the added code complexity is left for future work.
